...
<div class="rTableHead"style="width: 15%;"><span style="font-weight: bold;">DeptName</span></div>
<div class="rTableHead" style="width: 15%;"><span style="font-weight: bold;">CourseCode</span></div>
<div class="rTableHead" style="width: 15%;"><span style="font-weight: bold;">CourseName</span></div>
<div class="rTableHead" style="width: 20%;">CourseDesctiption</div>
<div class="rTableHead" style="width: 15%;">Remove</div>
</div>

<c:forEach var="course" items="${courses }" varStatus="st">
<div class='rTableRow'>
				<div class='rTableCell' style="width: 10%;">${st.count }</div>
				<div class='rTableCell' style="width: 15%;">${course.deptName}</div>
				<div class='rTableCell' style="width: 15%;">${course.ccode}</div>
				<div class='rTableCell' style="width: 15%;">${course.courseName}</div>
				<div class='rTableCell' style="width: 20%;">${course.descr} </div>
				<div class='rTableCell' style="width: 15%;"><a href="deletecourse.htm?cid=${course.courseId }">Delete</a></div>
