			 ...
			 <li class="dropdown">
				 ...
				 <li class="dropdown">
				  ...
				  <ul class="dropdown-menu active">
					...
					<li class="kopie"><a href="studentresult.htm">Student Results</a></li>
					</ul>
				</li>
...
<div class="row register">
  ...
  <form id="form1" runat="server">
	<h2><font face="BlackLetter" color="green"> <strong>	Welcome to Online Examination System</strong></font></h2>
</form>
