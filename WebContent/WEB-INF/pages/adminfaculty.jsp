			 ...
			 <li class="dropdown">
				...
				<li class="dropdown">
				  ...
				  <ul class="dropdown-menu active">
					...
					<li class="kopie"><a href="adminfacreport.htm">Faculty Reports</a></li>
...
<h2><strong>Faculty Details</strong></h2>
<div class="rTable">
<div class="rTableRow">
<div class="rTableHead" style="width: 9%;"><strong>SNO</strong></div>
<div class="rTableHead" style="width: 14%;"><span style="font-weight: bold">DeptName</span></div>
<div class="rTableHead"  style="width: 14%;">FacultyId</div>
<div class="rTableHead">FacultyName</div>
<div class="rTableHead" style="width: 20%;">Designation</div>
<div class="rTableHead" style="width: 14%;">Remove</div>
...
<div class='rTableRow'>
			...
			<div class='rTableCell' style="width: 14%;">${fac.deptName }</div>
			<div class='rTableCell'style="width: 14%;">${fac.facultyCode }</div> 
			<div class='rTableCell'>${fac.firstName }  .${fac.lastName }</div>
			<div class='rTableCell' style="width: 20%;">${fac.desg }</div>
			<div class='rTableCell' style="width: 14%;"><a href="deletefac.htm?fid=${fac.userId }">Delete</a></div>
