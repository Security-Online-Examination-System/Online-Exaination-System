...
<div class="rTable">
<div class="rTableRow">
<div class="rTableHead"style="width: 14%;"><strong>SNO</strong></div>
<div class="rTableHead" style="width: 14%;"><strong>Dept ID</strong></div>
<div class="rTableHead"><span style="font-weight: bold;">DeptName</span></div>
<div class="rTableHead">DeptDesctiption</div>
<div class="rTableHead" style="width: 14%;">Delete</div>
</div>

<c:forEach var="dept" items="${depts }" varStatus="st">
<div class='rTableRow'>
			<div class='rTableCell'style="width: 14%;">${st.count }</div>
			<div class='rTableCell' style="width: 14%;">${dept.deptId }</div>
			<div class='rTableCell'>${dept.deptName }</div>
			<div class='rTableCell'>${dept.deptDescription }</div>
			<div class='rTableCell' style="width: 14%;"><a href="deletedept.htm?did=${dept.deptId }">Delete</a></div>
			</div>
