...
<div class="rTable">
<div class="rTableRow">
<div class="rTableHead" style="width: 7%;"><strong>SNO</strong></div>
<div class="rTableHead" style="width: 25%;"><span style="font-weight: bold;">SubjectName</span></div>
<div class="rTableHead" style="width: 25%;"><span style="font-weight: bold;">Title</span></div>
<div class="rTableHead" style="width: 7%;"><span style="font-weight: bold;">Sem</span></div>
<div class="rTableHead" style="width: 10%;">Remove</div>

</div>

<c:forEach var="subject" items="${subjects }" varStatus="st">
<div class='rTableRow'>
				<div class='rTableCell' style="width: 7%;">${st.count }</div>
				<div class='rTableCell' style="width: 25%;">${subject.name}</div>
				<div class='rTableCell' style="width: 25%;">${subject.title}</div>
				<div class='rTableCell' style="width: 7%;">${subject.semester}</div>
				<div class='rTableCell' style="width: 10%;"><a href="deletesubject.htm?sid=${subject.subjectId }">Delete</a></div>
